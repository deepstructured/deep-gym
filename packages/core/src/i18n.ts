...
const en = {
  ...
  "workout.previousSession": "Last time",
  "workout.liveSummary": "This session",
  "workout.shortcutSave": "Save workout",
  "workout.shortcutAddSet": "Add set",
  ...
  "workout.draftConflictTitle": "Two workout drafts found",
  "workout.draftConflictMessage": "This device and your account each have an unsaved workout. Choose which copy to keep. The other copy will be replaced.",
  "workout.draftKeepDevice": "Keep this device",
  "workout.draftKeepCloud": "Use account copy",
  ...
  "workout.noPrevious": "No previous workout of this type yet",
  "workout.invalidDate": "Date must be YYYY-MM-DD",
  "workout.completedSetRequired": "Enter at least one completed set",
  ...
  "workout.serverUpdateRequired":
    "Workout saving requires a server update. Try again after migration 0009 is applied.",
  "workout.alreadySavedConflict":
    "This draft was already saved with different details. Your edits remain here. Open the saved workout in History to update it.",
  "workout.draftNotReady": "Workout draft is not ready. Try again.",
  "workout.draftCloudPending": "Checking your saved draft. If this takes a while, check your connection.",
  ...
  "settings.deleteAccountMessage":
    "Your workouts, exercises, templates, body weight history and profile will be deleted. This cannot be undone.",
  ...
  "firstWorkout.mobileFormTip":
    "If your exercise list is empty, create one right here. Enter reps, then save your workout.",
  ...
  "login.configUnavailable": "Sign-in is temporarily unavailable. Try again later.",
  "login.callbackMissingCode": "Sign-in link is incomplete. Try again.",
  "login.backToSignIn": "Back to sign-in",
  "login.signInFailed": "Could not sign in. Try again.",
  "login.invalidCredentials": "Sign-in details are incorrect. Try again.",
  "login.googleSessionMissing": "Google did not complete sign-in. Try again.",
  "login.googleStartFailed": "Google sign-in could not start. Try again.",
  "login.appleUnavailable": "Apple sign-in is unavailable on this device.",
  "login.appleRetry": "Apple sign-in could not finish. Try again.",
  "auth.sessionSlow": "Loading is taking too long",
  "auth.resetLocalSession": "Reset local session",
  "auth.profileUnavailable": "We couldn't open your profile. Retry or reset the local session.",
  "login.telegramUsernameRequired": "Enter your Telegram username.",
  "login.telegramNotLinked": "Open the DeepGym bot, press Start, then try again.",
  "login.telegramRateLimit": "Code already sent. Wait a minute before trying again.",
  "login.telegramBotUnavailable": "Open the DeepGym bot and press Start, then try again.",
  "login.telegramCodeRequired": "Enter the six-digit code.",
  "login.telegramUnknownUsername": "This Telegram username was not found.",
  "login.telegramCodeExpired": "Code expired. Request a new one.",
  "login.telegramTooManyAttempts": "Too many attempts. Request a new code.",
  "login.telegramWrongCode": "Wrong code. Attempts left: {count}.",
  "login.telegramVerifyBusy": "Verification is busy. Try again.",
  "login.telegramVerifyFailed": "Could not verify the code. Try again.",
  "login.telegramSendFailed": "Could not send the code. Try again.",
  "error.signInRequired": "Sign in to continue.",
  "error.nameRequired": "Enter a name.",
  "templates.completeRequired": "Add a name, type and at least one exercise.",
  "settings.deleteAccountSignInAgain": "Sign in again before deleting your account.",
  "settings.deleteAccountFailed": "Could not delete the account. Try again.",
  ...
  // interface mode (mobile / desktop shell)
  "ui.mode.title": "Interface",
  "ui.mode.auto": "Auto",
  "ui.mode.autoHint": "Desktop on a wide screen, phone layout otherwise.",
  "ui.mode.desktop": "Desktop",
  "ui.mode.desktopHint": "Top bar, wider layouts and denser screens.",
  "ui.mode.mobile": "Mobile",
  "ui.mode.mobileHint": "Always the phone layout, even on a large display.",
...
const ru: Record<MessageKey, string> = {
  ...
  "workout.previousSession": "Прошлый раз",
  "workout.liveSummary": "Эта тренировка",
  "workout.shortcutSave": "Сохранить тренировку",
  "workout.shortcutAddSet": "Добавить подход",
  ...
  "workout.draftConflictTitle": "Найдены два черновика",
  "workout.draftConflictMessage": "На устройстве и в аккаунте есть разные незавершённые тренировки. Выберите, какой черновик оставить. Второй будет заменён.",
  "workout.draftKeepDevice": "Оставить на устройстве",
  "workout.draftKeepCloud": "Взять из аккаунта",
  ...
  "workout.noPrevious": "Тренировки этого типа пока не было",
  "workout.invalidDate": "Дата должна быть в формате ГГГГ-ММ-ДД",
  "workout.completedSetRequired": "Заполните хотя бы один выполненный подход",
  "workout.staleExerciseMode":
    "Упражнение из черновика сменило режим нагрузки или больше недоступно. Добавьте его заново и повторите сохранение.",
  "workout.serverUpdateRequired":
    "Для сохранения тренировок нужно обновить сервер. Повторите попытку после применения миграции 0009.",
  "workout.alreadySavedConflict":
    "Этот черновик уже был сохранён с другими данными. Ваши правки остались здесь. Откройте сохранённую тренировку в истории, чтобы изменить её.",
  "workout.draftNotReady": "Черновик тренировки ещё не готов. Повторите попытку.",
  "workout.draftCloudPending": "Проверяем сохранённый черновик. Если ожидание затянулось, проверьте подключение.",
  ...
  "settings.deleteAccountMessage":
    "Тренировки, упражнения, шаблоны, история веса и профиль будут удалены. Отменить это нельзя.",
  ...
  "firstWorkout.mobileFormTip":
    "Если список упражнений пуст, создайте первое прямо здесь. Укажите повторы и сохраните тренировку.",
  ...
  "login.configUnavailable": "Вход временно недоступен. Попробуйте позже.",
  "login.callbackMissingCode": "Ссылка для входа неполная. Попробуйте ещё раз.",
  "login.backToSignIn": "Вернуться ко входу",
  "login.signInFailed": "Не удалось войти. Попробуйте ещё раз.",
  "login.invalidCredentials": "Неверные данные для входа. Попробуйте ещё раз.",
  "login.googleSessionMissing": "Вход через Google не завершён. Попробуйте ещё раз.",
  "login.googleStartFailed": "Не удалось начать вход через Google. Попробуйте ещё раз.",
  "login.appleUnavailable": "Вход через Apple недоступен на этом устройстве.",
  "login.appleRetry": "Не удалось завершить вход через Apple. Попробуйте ещё раз.",
  "auth.sessionSlow": "Загрузка затянулась",
  "auth.resetLocalSession": "Сбросить локальную сессию",
  "auth.profileUnavailable": "Не удалось открыть профиль. Попробуйте ещё раз или сбросьте локальную сессию.",
  "login.telegramUsernameRequired": "Введите имя пользователя Telegram.",
  "login.telegramNotLinked": "Откройте бот DeepGym, нажмите Start и попробуйте ещё раз.",
  "login.telegramRateLimit": "Код уже отправлен. Подождите минуту перед повторной попыткой.",
  "login.telegramBotUnavailable": "Откройте бот DeepGym, нажмите Start и попробуйте ещё раз.",
  "login.telegramCodeRequired": "Введите шестизначный код.",
  "login.telegramUnknownUsername": "Это имя пользователя Telegram не найдено.",
  "login.telegramCodeExpired": "Срок действия кода истёк. Запросите новый.",
  "login.telegramTooManyAttempts": "Слишком много попыток. Запросите новый код.",
  "login.telegramWrongCode": "Неверный код. Осталось попыток: {count}.",
  "login.telegramVerifyBusy": "Проверка занята. Попробуйте ещё раз.",
  "login.telegramVerifyFailed": "Не удалось проверить код. Попробуйте ещё раз.",
  "login.telegramSendFailed": "Не удалось отправить код. Попробуйте ещё раз.",
  "error.signInRequired": "Войдите, чтобы продолжить.",
  "error.nameRequired": "Введите название.",
  "templates.completeRequired": "Укажите название, тип и хотя бы одно упражнение.",
  "settings.deleteAccountSignInAgain": "Войдите заново перед удалением аккаунта.",
  "settings.deleteAccountFailed": "Не удалось удалить аккаунт. Попробуйте ещё раз.",
  ...
  "ui.mode.title": "Интерфейс",
  "ui.mode.auto": "Авто",
  "ui.mode.autoHint": "Десктоп на широком экране, иначе мобильная вёрстка.",
  "ui.mode.desktop": "Десктоп",
  "ui.mode.desktopHint": "Верхняя панель, широкие раскладки и больше данных.",
  "ui.mode.mobile": "Мобильный",
  "ui.mode.mobileHint": "Всегда мобильная вёрстка, даже на большом экране.",
  "ui.collapseMenu": "Свернуть меню",
  "palette.title": "Быстрый поиск",
  "palette.placeholder": "Поиск или переход…",
  "palette.empty": "Ничего не найдено",
  "palette.actions": "Действия",
  "palette.navigate": "Перейти",
  "ui.expandMenu": "Развернуть меню",
  "widget.all": "Все",
...
const uk: Record<MessageKey, string> = {
  ...
  "workout.previousSession": "Минулого разу",
  "workout.liveSummary": "Це тренування",
  "workout.shortcutSave": "Зберегти тренування",
  "workout.shortcutAddSet": "Додати підхід",
  ...
  "workout.draftConflictTitle": "Знайдено дві чернетки",
  "workout.draftConflictMessage": "На пристрої та в акаунті є різні незавершені тренування. Оберіть, яку чернетку залишити. Другу буде замінено.",
  "workout.draftKeepDevice": "Залишити на пристрої",
  "workout.draftKeepCloud": "Взяти з акаунта",
  ...
  "workout.noPrevious": "Тренування цього типу ще не було",
  "workout.invalidDate": "Дата має бути у форматі РРРР-ММ-ДД",
  "workout.completedSetRequired": "Заповніть хоча б один виконаний підхід",
  "workout.staleExerciseMode":
    "Вправа з чернетки змінила режим навантаження або більше недоступна. Додайте її заново й повторіть збереження.",
  "workout.serverUpdateRequired":
    "Для збереження тренувань потрібно оновити сервер. Повторіть спробу після застосування міграції 0009.",
  "workout.alreadySavedConflict":
    "Цю чернетку вже збережено з іншими даними. Ваші правки залишилися тут. Відкрийте збережене тренування в історії, щоб змінити його.",
  "workout.draftNotReady": "Чернетка тренування ще не готова. Повторіть спробу.",
  "workout.draftCloudPending": "Перевіряємо збережену чернетку. Якщо очікування затягнулося, перевірте з’єднання.",
  ...
  "settings.deleteAccountTitle": "Видалити акаунт назавжди?",
  "settings.deleteAccountMessage":
    "Тренування, вправи, шаблони, історія ваги та профіль будуть видалені. Скасувати це не можна.",
  "settings.groupAccount": "Акаунт",
  ...
  "firstWorkout.mobileFormTip":
    "Якщо список вправ порожній, створіть першу прямо тут. Вкажіть повторення та збережіть тренування.",
  ...
  "login.configUnavailable": "Вхід тимчасово недоступний. Спробуйте пізніше.",
  "login.callbackMissingCode": "Посилання для входу неповне. Спробуйте ще раз.",
  "login.backToSignIn": "Повернутися до входу",
  "login.signInFailed": "Не вдалося увійти. Спробуйте ще раз.",
  "login.invalidCredentials": "Неправильні дані для входу. Спробуйте ще раз.",
  "login.googleSessionMissing": "Вхід через Google не завершено. Спробуйте ще раз.",
  "login.googleStartFailed": "Не вдалося почати вхід через Google. Спробуйте ще раз.",
  "login.appleUnavailable": "Вхід через Apple недоступний на цьому пристрої.",
  "login.appleRetry": "Не вдалося завершити вхід через Apple. Спробуйте ще раз.",
  "auth.sessionSlow": "Завантаження затягнулося",
  "auth.resetLocalSession": "Скинути локальну сесію",
  "auth.profileUnavailable": "Не вдалося відкрити профіль. Спробуйте ще раз або скиньте локальну сесію.",
  "login.telegramUsernameRequired": "Введіть ім'я користувача Telegram.",
  "login.telegramNotLinked": "Відкрийте бот DeepGym, натисніть Start і спробуйте ще раз.",
  "login.telegramRateLimit": "Код уже надіслано. Зачекайте хвилину перед повторною спробою.",
  "login.telegramBotUnavailable": "Відкрийте бот DeepGym, натисніть Start і спробуйте ще раз.",
  "login.telegramCodeRequired": "Введіть шестизначний код.",
  "login.telegramUnknownUsername": "Це ім'я користувача Telegram не знайдено.",
  "login.telegramCodeExpired": "Термін дії коду минув. Запитайте новий.",
  "login.telegramTooManyAttempts": "Забагато спроб. Запитайте новий код.",
  "login.telegramWrongCode": "Неправильний код. Залишилося спроб: {count}.",
  "login.telegramVerifyBusy": "Перевірка зайнята. Спробуйте ще раз.",
  "login.telegramVerifyFailed": "Не вдалося перевірити код. Спробуйте ще раз.",
  "login.telegramSendFailed": "Не вдалося надіслати код. Спробуйте ще раз.",
  "error.signInRequired": "Увійдіть, щоб продовжити.",
  "error.nameRequired": "Введіть назву.",
  "templates.completeRequired": "Вкажіть назву, тип і хоча б одну вправу.",
  "settings.deleteAccountSignInAgain": "Увійдіть знову перед видаленням акаунта.",
  ...
  "ui.mode.title": "Інтерфейс",
  "ui.mode.auto": "Авто",
  "ui.mode.autoHint": "Десктоп на широкому екрані, інакше мобільна верстка.",
  "ui.mode.desktop": "Десктоп",
  "ui.mode.desktopHint": "Верхня панель, ширші розкладки та більше даних.",
  "ui.mode.mobile": "Мобільний",
  "ui.mode.mobileHint": "Завжди мобільна верстка, навіть на великому екрані.",
  "ui.collapseMenu": "Згорнути меню",
  "palette.title": "Швидкий пошук",
  "palette.placeholder": "Пошук або перехід…",
  "palette.empty": "Нічого не знайдено",
  "palette.actions": "Дії",
  "palette.navigate": "Перейти",
  "ui.expandMenu": "Розгорнути меню",
  "widget.all": "Усі",
